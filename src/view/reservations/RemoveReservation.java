...
public class RemoveReservation extends JDialog {
	//Attributes
	private static final long serialVersionUID = 1L;
	private final JPanel contentPanel = new JPanel();

	//Create the Dialog
	public RemoveReservation(MainMenu caller, String date, String reservation) {
		...
		//Initial SetUp
		JLabel lblSeguroQueDeseas = new JLabel("Seguro que deseas eliminar esta reserva?");
		...
		iconLbl.setIcon(new ImageIcon(MainMenu.class.getResource("/view/reservations/warning.png")));
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				try {
					if (cont.removeReservation(caller, date, reservation)) {
						caller.rightMessage("Reservas eliminadas correctamente!");
					} else {
